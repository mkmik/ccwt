...
// in. A tab is a row of its own, not one of the list's worktrees whatever
// directory it carries: the keys that unmake things must not take it for one —
// what `r` does with a tab is its own thing, see below.
