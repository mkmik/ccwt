...
var cli struct {
	...
	Mr                MrCmd                `cmd:"" name:"mr" help:"Say where a review stands and what its pipeline did: \"ccwt mr <merge request url>\" for that one, or \"ccwt mr PROJ-1234\" (a Jira key, or its browse url) for a row per merge request that names the ticket. Asks glab."`
